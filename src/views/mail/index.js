            ...
            <div className="view-mail">
                ...
                <nav className={`email-nav p-4 ${navOpen}`}>
                    ...
                    <ul className="list-unstyled">
                        <li><a href="#n" className="active"><IconInbox size="16"/><span className="text">Inbox</span>&emsp;<span className="badge badge-primary">15</span></a></li>
                        <li><a href="#n"><IconSent size="16"/><span className="text">Sent</span>&emsp;<span className="badge badge-success">3</span></a></li>
                        <li><a href="#n"><IconDraft size="16"/><span className="text">Drafts</span>&emsp;<span className="badge badge-warning">1</span></a></li>
                        <li><a href="#n"><IconChat size="16"/><span className="text">Chats</span></a></li>
                        <li><a href="#n"><IconTrash size="16"/><span className="text">Trash</span></a></li>
                    </ul>
